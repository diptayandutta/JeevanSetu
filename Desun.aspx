<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Desun.aspx.cs" Inherits="Desun" %>
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top"><em>DESUN HOSPITAL KOLKATA</em></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                   ...
                   <li>
                    ...
                    <li>
                        <a class="page-scroll" href="Desun_doctor.aspx" target="iframe1">DOCTORS</a>
                    </li>
                      <li>
...
<asp:Label ID="Label1" runat="server" Text="Desun Hospital Kolkata" Visible="false"></asp:Label>
