<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Amri.aspx.cs" Inherits="Amri" %>
...
<body id="page-top">
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top"><em>AMRI HOSPITAL KOLKATA</em></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                   ...
                   <li>
                    ...
                    <li>
                        <a class="page-scroll" href="Amri_doctor.aspx" target="iframe1">DOCTORS</a>
                    </li>
    ...
    <section id="procedures" style="background-color:floralwhite; height:700px ">
        ...
        <asp:Label ID="Label1" runat="server" Text="Amri Hospital Kolkata" Visible="false"></asp:Label>
    </section>
