<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Fortis.aspx.cs" Inherits="Fortis" %>
...
<body id="page-top">
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top"><em>FORTIS HOSPITAL KOLKATA</em></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="Fortis_doctor.aspx" target="iframe1">DOCTORS</a>
                    </li>
                      <li>
    ...
    <section class="no-padding" id="doctors"  >
        <div class="container-fluid">
            <div class="row no-gutter">
               
  </div>
</div>
<asp:Label ID="Label1" runat="server" Text="Fortis Hospital Kolkata" Visible="false"></asp:Label>
